...
sc_colours <- list(
  list('#000000','#2f2e2e','#4b4949','#6a6767','#8d8989','#b7b3b7','#e0dde0','#ffffff'),
  list('#220000','#4f0101','#750101','#a90000','#d80102','#fd0000','#f93131','#f93131'),
  list('#311700','#572902','#7f3c02','#a74f03','#d26306','#fe7706','#f98d33','#fbab68'),
  list('#312f01','#5c5904','#8d880a','#b9b210','#dcd416','#f8e71c','#f9f240','#f6f278'),
  list('#023101','#0a5e05','#0f8409','#15a90f','#1bce15','#22ff1b','#4dfc47','#7bf976'),
  list('#10243d','#1b3a62','#234d83','#007baf','#00a0af','#04c2d4','#54ebf9','#92f3fc'),
  list('#1e0c3a','#301458','#4b1f8b','#632ab5','#7a36dc','#8b40f7','#9c5df8','#b486f8'),
  list('#24050e','#3a0d1b','#561328','#851c3e','#ba2958','#e2356d','#fb6796','#f893b4')
)
