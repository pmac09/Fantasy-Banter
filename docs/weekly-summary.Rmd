...
# summary <- read.csv("/Users/paulmcgrath/Github/Fantasy-Banter/analysis/2022/Simulations/simulation_R8_summary.csv")
# 
# summary <- summary %>%
#   select(coach, pcnt_finals, pcnt_gfinal, pcnt_champ)
# 
...
#   summary,
#   pagination = FALSE,
#   defaultSorted = "pcnt_champ",
#   defaultSortOrder = "desc",
#   defaultColGroup = colGroup(headerClass = "group-header"),
#   columnGroups = list(
#     colGroup(name = "Finals Chances", columns = c('pcnt_finals', 'pcnt_gfinal', 'pcnt_champ'))
#   ),
