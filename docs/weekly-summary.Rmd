...
highchart() %>%
  ...
  hc_add_series_list(ladder_journey)
...
brks <- c(70,75,80,85,90,95,100)-0.01
...
datatable(
  ...
  formatStyle(names(pos_smy_fltr[,c(4:ncol(pos_smy_fltr))]), 
...
brks <- c(70,75,80,85,90,95,100)+10-0.01
clrs <- brewer.pal(8, 'RdYlGn')
