...
# saveRDS(player_data, './data/2023/player_data.RDS')
# saveRDS(league_data, './data/2023/league_data.RDS')

player_data <- readRDS('../data/2023/player_data.RDS')
league_data <- readRDS('../data/2023/league_data.RDS')
...
sim_data <- read.csv(paste0('../data/2023/simulations/R',vRound,'_sim_smy.csv')) %>%
